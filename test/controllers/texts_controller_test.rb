...
class TextsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create text" do
    assert_difference('Text.count') do
      post texts_url, params: { text: { content: @text.content, location: @text.location, title: @text.title, wall_id: @text.wall_id } }
    end
  ...
  test "should update text" do
    patch text_url(@text), params: { text: { content: @text.content, location: @text.location, title: @text.title, wall_id: @text.wall_id } }
